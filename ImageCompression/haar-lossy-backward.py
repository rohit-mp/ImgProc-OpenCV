...
haar2d = cv2.imread('haar2d-lossy.jpg',0).astype('float32')
haar1d = cv2.imread('haar2d-lossy.jpg',0).astype('float32')
img = cv2.imread('haar2d-lossy.jpg',0)
...
cv2.imshow('img',img)
cv2.imwrite('haar2d-lossy-inverse.jpg',img)
cv2.waitKey(0)
